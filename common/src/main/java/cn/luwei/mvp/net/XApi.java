...
import cn.luwei.mvp.net.Interceptor.LogInterceptor;
import cn.luwei.mvp.net.Interceptor.XInterceptor;
...
public class XApi {
    ...
    public Retrofit getRetrofit(String baseUrl, NetProvider provider, boolean useRx) {
        ...
        Retrofit.Builder builder = new Retrofit.Builder()
                ...
                //自定义转换器
                .addConverterFactory(sProvider.configConverterFactory());
