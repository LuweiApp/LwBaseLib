...
public class MultiTypeAdapter extends RecyclerView.Adapter<ViewHolder> {
  ...
  protected int indexInTypesOf(int position, @NonNull Object item) throws BinderNotFoundException {
  ...
  @CallSuper
  @SuppressWarnings("unchecked")
  protected void registerWithoutChecking(@NonNull Class clazz, @NonNull ItemViewBinder binder, @NonNull Linker linker) {
    checkAndRemoveAllTypesIfNeeded(clazz);
